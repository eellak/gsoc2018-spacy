...
NOUNS = set("""
 ...
 θάψιμο θέα θέαινα θέαμα θέαση θέατρο θέλγητρο θέλγητρον θέλημα θέληση θέλησις
 ...
 μήκυνση μήκυνσις μήκων μήλα μήλη μήλιος μήλο μήνας μήνη μήνιγγα μήνιγξ μήνις
